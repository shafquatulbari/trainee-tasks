...
}(Animal); // Using promises and async/await
...
var showInfo = function showInfo(_ref2) {
  ...
  console.log("Name: ".concat(name, ", Age: ").concat(age, ", Extra Info: ").concat(JSON.stringify(rest)));
};
...
var mergedPerson = _objectSpread(_objectSpread({}, person1), person2);

// Running the code
console.log(greet("Mark Antony"));
var caesar = new Dog("Caesar");
